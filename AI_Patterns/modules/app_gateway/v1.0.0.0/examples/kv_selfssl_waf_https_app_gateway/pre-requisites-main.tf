...
resource "azurerm_subnet" "frontend" {
  # checkov:skip=CKV2_AZURE_31: Not in scope for this example - Subnet is not associated with a Network Security Group.
...
resource "azurerm_key_vault" "keyvault" {
  # checkov:skip=CKV_AZURE_189: Not in scope for this example - Key Vault public network access is not restricted.
  # checkov:skip=CKV_AZURE_109: Not in scope for this example - Key Vault firewall rules are not configured.
  # checkov:skip=CKV_AZURE_110: Not in scope for this example - Key Vault purge protection is disabled.
  # checkov:skip=CKV_AZURE_42: Not in scope for this example - Key Vault soft delete and purge protection are not enforced.
  # checkov:skip=CKV2_AZURE_32: Not in scope for this example - Key Vault private endpoint is not configured.
  location                        = azurerm_resource_group.rg_group.location
