...
- Validate workload-specific settings before moving from `v1.0.0.0` to `v1.0.0.2`, especially networking, authentication, and private endpoint behaviour.
...
- Public access, private endpoint access, and slot-specific private endpoints are supported depending on configuration, but `v1.0.0.2` is intended for private-access-first deployments.
