...
resource "azapi_resource" "bing_account" {
  ...
  body = {
    ...
    properties = {
      statisticsEnabled = each.value.statistics_enabled
    }
    tags = module.bing_search.tags
  }
