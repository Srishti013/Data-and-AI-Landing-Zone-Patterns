module "module_sa" {
  ...
  # ...pass all naming/tag variables as in resource group module...
  env                  = var.env
  org                  = var.org
...
# trunk-ignore(checkov/CKV2_AZURE_33)
# trunk-ignore(checkov/CKV2_AZURE_38)
# trunk-ignore(checkov/CKV_AZURE_36)
# trunk-ignore(checkov/CKV_AZURE_44)
# trunk-ignore(checkov/CKV_AZURE_244)
# trunk-ignore(checkov/CKV_AZURE_35)
resource "azurerm_storage_account" "this" {
  #checkov:skip=CKV_AZURE_59:Public access controlled by variable
  #checkov:skip=CKV_AZURE_33:Queue logging controlled by variable
  #checkov:skip=CKV_AZURE_206:Replication type controlled by variable
  #checkov:skip=CKV_AZURE_36:Trusted MS services controlled by variable
  #checkov:skip=CKV_AZURE_35:Network default action controlled by variable
  #checkov:skip=CKV2_AZURE_40:Shared key authorization controlled by variable
  #checkov:skip=CKV2_AZURE_38:Soft-delete controlled by variable
  #checkov:skip=CKV_AZURE_43:Storage account name generated by naming module
  name                              = module.module_sa.name
  location                          = module.module_sa.location
  tags                              = merge(module.module_sa.tags, var.tags != null ? var.tags : {})
