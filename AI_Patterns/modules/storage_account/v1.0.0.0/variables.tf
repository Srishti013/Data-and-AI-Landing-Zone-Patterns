...
variable "review_required" {
  ...
  validation {
    condition     = var.review_required == "" || contains(["Yes", "No"], var.review_required)
    error_message = "Value must be Yes or No."
  }
  default = ""
}
...
variable "region_code" {
  type        = string
  description = "(Optional) {org} region code.<br></br>&#8226; Value of `region_code` must be one of: `[sea,ea,eu]`."
  validation {
