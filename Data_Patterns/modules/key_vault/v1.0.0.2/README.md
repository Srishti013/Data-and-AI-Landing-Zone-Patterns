...
- Update module source from modules/key_vault/v1.0.0.1 to modules/key_vault/v1.0.0.2.
...
| Name | Source | Version |
|------|--------|---------|
| key_vault | [IAC link](https://github.com/your-org/iac-modules/tree/main/modules/key_vault) | v1.0.0.2 |
...
```main.tf
module "key_vault" {
  source = "../../modules/key_vault/v1.0.0.2"
