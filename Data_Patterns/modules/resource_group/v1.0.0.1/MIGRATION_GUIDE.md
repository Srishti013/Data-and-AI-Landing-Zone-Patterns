...
**Note**: `business_owner` is now auto-mapped from `owner` variable
...
**Note**: `environment` is now auto-mapped from `env` variable
...
- ✅ Enum values for `data_classification`, `criticality`, `status`
