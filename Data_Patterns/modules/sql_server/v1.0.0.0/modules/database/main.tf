resource "azurerm_mssql_database" "this" {
  ...
  # Both attributes are RequiredWith each other. Only set the rotation flag when a database-level
  # CMK key is supplied; otherwise leave it null so the database inherits the server TDE protector.
