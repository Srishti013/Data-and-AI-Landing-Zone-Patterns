...
variable "azure_integration_runtime_azure" {
  description = "Map of Azure Data Factory Azure Integration Runtime configurations"
...
# Managed Private Endpoints for Data Factory
variable "managed_private_endpoints" {
  description = "Map of Managed Private Endpoints for Data Factory. Key is a unique identifier, value is an object with required variables to look up the Data Factory and explicitly identify the target resource details."
