...
resource "azurerm_private_endpoint" "this_managed_dns_zone_groups" {
  ...
  location                      = each.value.location != null ? each.value.location : module.module_rsv.location
  name                          = each.value.name != null ? each.value.name : "pep-${module.module_rsv.name}"
  ...
  private_service_connection {
    ...
    name                           = each.value.private_service_connection_name != null ? each.value.private_service_connection_name : "pse-${module.module_rsv.name}"
