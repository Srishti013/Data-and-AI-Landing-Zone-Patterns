...
# Deprecated: location is now provided by the naming module (naming_module v1.0.0.1)
# variable "location" {
#   type        = string
...
# Deprecated: name is now provided by the naming module (naming_module v1.0.0.1)  
...
variable "sku" {
  ...
  description = <<-DESCRIPTION
 - `name` - (Required) The Name of the SKU to use for this Application Gateway. Must be `WAF_v2` for security compliance.
 - `tier` - (Required) The Tier of the SKU to use for this Application Gateway. Must be `WAF_v2` for security compliance.
 - `capacity` - (Optional) The Capacity of the SKU to use for this Application Gateway. For V2 SKU, value must be between `1` and `125`. This property is optional if `autoscale_configuration` is set.
DESCRIPTION
  nullable    = false

  # validation {
  #   condition     = var.sku.name == "WAF"
  #   error_message = "SKU name must be 'WAF_v2'. This module enforces WAF for security compliance."
  # }
  # validation {
  #   condition     = var.sku.tier == "WAF"
  #   error_message = "SKU tier must be 'WAF_v2'. This module enforces WAF for security compliance."
  # }
}
...
variable "waf_configuration" {
  ...
  description = <<-DESCRIPTION
Web Application Firewall configuration for OWASP protection. Defaults to enabled with Prevention mode and OWASP 3.2 ruleset for security compliance.

 - `enabled` - (Required) Is the Web Application Firewall enabled? Defaults to `true`.
 ...
 - `firewall_mode` - (Required) The Web Application Firewall Mode. Possible values are `Detection` and `Prevention`. Defaults to `Prevention` for security compliance.
 ...
 - `rule_set_version` - (Required) The Version of the Rule Set used for this Web Application Firewall. Possible values are `0.1`, `1.0`, `2.1`, `2.2.9`, `3.0`, `3.1` and `3.2`. Defaults to `3.2` (latest OWASP ruleset).
...
# -
# Naming Module Variables (v1.0.0.1)
# -
...
# -
# Optional Naming Module Variables
# -
variable "org" {
  type        = string
...
variable "region_code" {
  type        = string
  description = "(Optional) mbb region code.<br></br>&#8226; Value of `region_code` must be one of: `[sea,ea,eu,myw]`."
  validation {
