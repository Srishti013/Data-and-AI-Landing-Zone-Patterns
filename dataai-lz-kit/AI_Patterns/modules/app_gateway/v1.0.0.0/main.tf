...
resource "azurerm_public_ip" "this" {
  ...
  location            = module.module_appgw.location
  ...
  tags                = merge(module.module_appgw.tags, var.tags != null ? var.tags : {})
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-${module.module_appgw.name}"
