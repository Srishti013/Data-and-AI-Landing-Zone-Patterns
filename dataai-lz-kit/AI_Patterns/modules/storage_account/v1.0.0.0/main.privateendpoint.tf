...
resource "azurerm_private_endpoint" "this" {
  ...
  location                      = each.value.location != null ? each.value.location : module.module_sa.location
  name                          = each.value.name != null ? each.value.name : "pe-${module.module_sa.name}"
  ...
  private_service_connection {
    ...
    name                           = each.value.private_service_connection_name != null ? each.value.private_service_connection_name : "pse-${module.module_sa.name}"
