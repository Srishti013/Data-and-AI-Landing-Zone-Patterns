...
resource "azurerm_private_endpoint" "this" {
  ...
  location                      = coalesce(each.value.location, module.module_ai_search.location)
  name                          = each.value.name != null ? each.value.name : "pe-${module.module_ai_search.name}"
  ...
  private_service_connection {
    ...
    name                           = each.value.private_service_connection_name != null ? each.value.private_service_connection_name : "psc-${module.module_ai_search.name}"
