...
- This is the intial version to deploy Azure AI Search Service in Azure and no notable changes for version 1.0.0.1.
...
### How to fetch this product from Azure Artifact

- task created in the pipeline (yaml)
...
| <a name="input_region_code"></a> [region\_code](#input\_region\_code) | (Required) bbl region code.<br></br>&#8226; Value of `region_code` must be one of: `[sea,ea]`. | `string` | `"sea"` | yes |
| <a name="input_app_code"></a> [app\_code](#input\_region\_code) | (Required)  bbl application code.<br></br>&#8226; Example: `network`, `mgmt`, `build`. | `string` | `"build"` | yes |
| <a name="input_bu_code"></a> [bu\_code](#input\_region\_code) | (Required)  bbl bu code.<br></br>&#8226; Example: `it`, `core`. | `string` | `"core"` | yes |
| <a name="input_product version"></a> [product\_version](#input\_region\_code) | (Required)  product Version that are being used from Azure artifact.<br></br>&#8226; Example: `1.0.0`, `1.0.2`,`2.0.0`. | `string` | `"1.0.0"` | yes |
...
| <a name="input_country"></a> [country](#input\_country) | (Optional) bbl country code. Example: `bkk`. | `string` | `"bkk"` | no |
...
| <a name="input_scale_units"></a> [scale\_units](#input\_scale\_units) | (Optional) Number of Scale units to allocate. | `number` | `5` | no |
| <a name="resource_group"></a> [resource\_group](#resource\_group) | (Required) The Resource group of the AI Search. | `string` | n/a | yes |
| <a name="skup"></a> [sku](#sku) | (Required) The sku of the AI Search. | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_resource"></a> [id](#output\_resource\_id) | The Resource ID of the created Azure AI Search. |
| <a name="output_private_endpoint"></a> [private\_endpoint](#output\_private\_endpoint) | Private endpoint of the Azure AI Search. |
| <a name="output_resource_id"></a> [reource\_id](#output\_resource\_id) | The Resource ID of the Azure AI Search. |
