resource "azurerm_application_insights" "this" {
  ...
  location                              = coalesce(var.application_insights.location, module.module_appservice.location)
  name                                  = coalesce(var.application_insights.name, "ai-${module.module_appservice.name}")
  ...
  tags                                  = var.application_insights.inherit_tags ? merge(module.module_appservice.tags, var.tags != null ? var.tags : {}, var.application_insights.tags) : var.application_insights.tags
...
resource "azurerm_application_insights" "slot" {
  ...
  name                                  = coalesce(each.value.name, "ai-${module.module_appservice.name}")
  ...
  tags                                  = each.value.inherit_tags ? merge(module.module_appservice.tags, var.tags != null ? var.tags : {}, each.value.tags) : each.value.tags
