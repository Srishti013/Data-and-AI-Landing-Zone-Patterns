...
variable "business_owner" {
  type        = string
  description = "(Required) Contact name of the business owner."
}
...
variable "region_code" {
  type        = string
  description = "(Optional) mbb region code.<br></br>&#8226; Value of `region_code` must be one of: `[sea,ea,eu,sg,idc]`."
  validation {
...
# -
# Additional Optional Tags for Resource Group Module v1.0.0.1
# -
