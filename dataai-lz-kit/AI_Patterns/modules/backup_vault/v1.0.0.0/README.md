...
| Name | Source | Version |
|------|--------|---------|
| mbb_backup_vault | [IAC link](https://github.com/maybank-ghes/mbb-az-iac-modules/tree/main/modules/mbb_backup_vault) | v1.0.0.0 |
...
```main.tf
module "backup_vault" {
  source = "../../modules/mbb_backup_vault/v1.0.0.0"
